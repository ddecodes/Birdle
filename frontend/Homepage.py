...
def render():
    ...
    with col1:
            st.image("frontend/1st image landing page.jpg")
    with col2:
            st.header("Birdle")
    ...
    with col2:
        st.image("frontend/2nd image landing page.png")
        st.header("     ")     
    col1 , col2 = st.columns([1,0.3])
    with col1:
        st.image("frontend/3rd image landing page.jpg")    
    with col2:
    ...
    with col2:    
        st.image("frontend/4th image landing page.jpg") 
